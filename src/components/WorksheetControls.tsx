import { WorksheetConfig, WorksheetMode, GridSize, Difficulty, BorderStyle, HeaderFontSize, ShapeName, ALL_SHAPES, SHAPE_COLORS, OddOneOutType, HandwritingPaperStyle, HandwritingFontSize, HandwritingFont, HandwritingSubMode, HandwritingLineColor, HandwritingHighlightColor, MazeSize, MazeShape, ConnectDotsShape, TracingStrokeType, TracingThickness, ScissorLineType, ColorByNumberTheme, GridDesignSize, GridDesignPattern, DotArtTheme, DotArtDotSize, DotArtSpacing, ShapeTracingShape, ShapeTracingSize, SpotDiffTheme, SpotDiffCount, VisualScanDensity, VisualScanCharSize, PixelArtTheme } from '@/lib/shapes';
